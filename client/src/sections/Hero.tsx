...
const Hero = () => {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      if (headingRef.current) {
        headingRef.current.style.transition = 'opacity 1.2s ease, transform 1.2s ease';
    ...
    setTimeout(() => {
      if (buttonsRef.current) {
        buttonsRef.current.style.transition = 'opacity 1s ease, transform 1s ease';
    ...
    setTimeout(() => {
      if (scrollIndicatorRef.current) {
        scrollIndicatorRef.current.style.transition = 'opacity 1s ease, transform 1s ease';
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 z-10 text-center">
        <h1 ref={headingRef} className="font-['Press_Start_2P'] text-3xl md:text-5xl lg:text-6xl mb-6">
          <span className="block transform transition-transform hover:scale-105 duration-300">FULL STACK</span>
          <span className="block text-[#39FF14] transform transition-transform hover:scale-105 duration-300 mt-2">MERN DEVELOPER</span>
        </h1>
