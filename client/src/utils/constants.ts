...
export const projects: Project[] = [
  ...
  },
  {
    ...
    year: "2023",
    technologies: ["React", "Three.js", "Webflow", "TypeScript", "GSAP"],
    ...
    longDescription: "Different by Design is a creative studio that wanted their website to reflect their innovative approach to design. I created a website that features interactive 3D elements using Three.js, smooth transitions with GSAP, and a unique visual language that sets them apart from competitors."
  },
  {
    id: 3,
